...
$ R <enter>
> install.packages(c('leaflet','repr', 'IRdisplay', 'pbdZMQ', 'uuid'), dependencies = TRUE)
...
with default parameters to jupyterlab and #SBATCH.
...
function create_environment
{
  ...
  echo -e "SLURM script to run the JupyterLab\n"
...
function menu
{
  ...
  Starts the SLURM script to run the JupyterLab.
  "
  usage
}
